...
public class ToString {
    ...
    public static String NoPlayerToSpawn = MessageUtil.getLang("top.mtserver.cat.NoPlayerToSpawn");
    ...
    public static String AreaNotLoadingGiveUpSpawn = MessageUtil.getLang("top.mtserver.cat.AreaNotLoadingGiveUpSpawn");
